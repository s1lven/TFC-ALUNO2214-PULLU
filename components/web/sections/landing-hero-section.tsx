        ...
        <div className="bg-neutral-900 rounded-3xl px-6 py-16 sm:py-24 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
              Save <span className="text-brand">hours</span> by generating complete{" "}
              <span className="text-brand">product listings in one click.</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="/auth/login"
              className="px-6 py-3 bg-brand hover:bg-brand-hover transition-all text-gray-900 font-semibold text-sm rounded-lg shadow-lg"
            >
              Try for free - Start listing products in seconds
            </a>
            <button type="button" className="px-6 py-3 bg-transparent border-2 border-gray-600 hover:border-gray-500 transition-all text-white font-semibold text-sm rounded-lg flex items-center gap-2">

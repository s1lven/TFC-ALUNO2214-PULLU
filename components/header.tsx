      ...
      >
        <div className={`px-4 sm:px-6 lg:px-8 flex items-center justify-between transition-all duration-300 ${
          ...
          <Link href="/" className="flex items-center gap-2 cursor-pointer">
            ...
            <div className={`text-2xl font-bold text-gray-900 ${leagueSpartan.className}`}>pullu</div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/login" className="text-gray-600 hover:text-gray-900 transition-colors text-sm font-medium cursor-pointer">Get started</Link>

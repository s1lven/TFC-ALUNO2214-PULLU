...
export function AccountOpenAiKeyCard({
  keyStatus,
  keyLoading,
  keyMessage,
  newKey,
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      ...
      <p className="text-sm text-gray-600 mb-4">
        AI translation and text enhancement use your key. The full secret is never shown again after you save—only the last four characters.
      </p>
      ...
      {keyLoading ? (
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:items-end">
              <div className="flex-1 min-w-0">
                <label className="text-xs font-medium text-gray-700 block mb-1" htmlFor="account-openai-replace">
                  New API key
                </label>
                <Input
                  id="account-openai-replace"
                  type="password"
                  autoComplete="off"
                  placeholder="sk-…"
                  value={newKey}
        ...
        <div className="space-y-4">
          <p className="text-sm text-gray-600">Add your key below to use AI translation and enhancement.</p>
          <div className="flex flex-col sm:flex-row gap-2 sm:items-end">
            <div className="flex-1 min-w-0">

...
import { TextBoldFreeIcons, TextItalicFreeIcons, TextUnderlineFreeIcons, TextAlignLeftFreeIcons, TextAlignCenterFreeIcons, TextAlignRightFreeIcons, LeftToRightListBulletFreeIcons, LeftToRightListNumberFreeIcons, HeadingFreeIcons, LinkFreeIcons, ImageFreeIcons, UndoFreeIcons, RedoFreeIcons, CodeFreeIcons, LeftToRightBlockQuoteFreeIcons } from '@hugeicons/core-free-icons';
    ...
    <div className="border border-gray-200 rounded-lg bg-white overflow-hidden">
      ...
      <div className="flex items-center gap-1 p-2 border-b border-gray-200 bg-gray-50 flex-wrap">
        ...
        <button
          ...
          title="Bold"
        >
          <HugeiconsIcon icon={TextBoldFreeIcons} size={18} />
        </button>
        <button
          ...
          title="Italic"
        >
          <HugeiconsIcon icon={TextItalicFreeIcons} size={18} />
        </button>
        <button
          ...
          title="Underline"
        >
          <HugeiconsIcon icon={TextUnderlineFreeIcons} size={18} />
        </button>
        ...
        <button
          ...
          title="Heading 1"
        >
          <HugeiconsIcon icon={HeadingFreeIcons} size={18} />
        </button>
        <button
          ...
          title="Heading 2"
        >
          <HugeiconsIcon icon={HeadingFreeIcons} size={16} />
        </button>
        ...
        <button
          ...
          title="Align Left"
        >
          <HugeiconsIcon icon={TextAlignLeftFreeIcons} size={18} />
        </button>
        <button
          ...
          title="Align Center"
        >
          <HugeiconsIcon icon={TextAlignCenterFreeIcons} size={18} />
        </button>
        <button
          ...
          title="Align Right"
        >
          <HugeiconsIcon icon={TextAlignRightFreeIcons} size={18} />
        </button>
        ...
        <button
          ...
          title="Bullet List"
        >
          <HugeiconsIcon icon={LeftToRightListBulletFreeIcons} size={18} />
        </button>
        <button
          ...
          title="Ordered List"
        >
          <HugeiconsIcon icon={LeftToRightListNumberFreeIcons} size={18} />
        </button>
        ...
        <button
          ...
          title="Code Block"
        >
          <HugeiconsIcon icon={CodeFreeIcons} size={18} />
        </button>
        <button
          ...
          title="Blockquote"
        >
          <HugeiconsIcon icon={LeftToRightBlockQuoteFreeIcons} size={18} />
        </button>
        ...
        <div className="relative">
          ...
          >
            <HugeiconsIcon icon={LinkFreeIcons} size={18} />
          </button>
          {showLinkInput && (
        ...
        <div className="relative">
          <button
            ...
            title="Add Image"
          >
            <HugeiconsIcon icon={ImageFreeIcons} size={18} />
          </button>
          {showImageInput && (
            <div className="absolute top-full left-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-lg p-3 z-10 w-64">
              <input
        ...
        <button
          ...
          title="Undo"
        >
          <HugeiconsIcon icon={UndoFreeIcons} size={18} />
        </button>
        <button
          ...
          title="Redo"
        >
          <HugeiconsIcon icon={RedoFreeIcons} size={18} />
        </button>
      </div>

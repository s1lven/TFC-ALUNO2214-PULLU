...
export default async function DashboardLayout({
  ...
  return (
    <div className="h-screen flex overflow-hidden" style={{ backgroundColor: '#F1F5F2' }}>
      {/* Sidebar */}
      <div className="w-64 bg-white flex flex-col border-r border-gray-200">
        ...
        <div className="p-4 border-t border-gray-200">
          <DashboardUserMenu userName={userName} userEmail={userEmail} />
        </div>
      </div>

      {/* Main Content */}
      <div className="flex-1 flex flex-col overflow-hidden" style={{ backgroundColor: '#F1F5F2' }}>
        <main className="flex-1 overflow-y-auto" style={{ backgroundColor: '#F1F5F2' }}>
          {children}
        </main>
      </div>
    </div>
